...
- **Frontend:** Next.js 16.2.3 (App Router), React 19.2.4, Tailwind CSS, shadcn/ui
- **Auth:** NextAuth.js 4.24 (Credentials provider — email/password)
- **ORM:** Prisma 5.22
- **Base de dados:** PostgreSQL 16
- **Validação:** Zod 4
- **Logging:** Pino 10 (`src/lib/logger.ts`)
- **File storage:** MinIO (S3-compatible, self-hosted)
- **Extração de documentos:** `pdftotext` (poppler-utils), `mammoth` (.docx→text)
- **API Claude:** `@anthropic-ai/sdk` 0.86.1
...
│       ├── agents/                    ← Prompts de fase (NÃO são subagentes Claude Code)
│       ├── references/
│       ├── scripts/
│       └── assets/
├── src/
...
- Todos os textos de interface em PT-PT (o utilizador é advogado em Portugal)
